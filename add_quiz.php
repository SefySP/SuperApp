    ...
    <div class="container">
        ...
        <main>
            ...
            <form name="form_add" id="form_add_id">
                <div id="div_select">
                    <select name="quiz_dif" id="quiz_dif_id" class='text_field' no autocomplete>
                ...
                <div>
                    <select name="quiz_type" id="quiz_type_id" class='text_field' onchange="loadAddQuiz()" no autocomplete>
                        <option value="Select" selected>
                            Select
                        </option>
                        <option value="T/F">
